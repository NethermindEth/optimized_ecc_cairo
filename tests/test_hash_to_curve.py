...
async def test_expanded_hash_to_curve(
    ...
    def split_uint256(a):
        return split(a, length=2)

    execution_info = await hash_to_curve_factory.exp_hash_to_curve(split_uint256(u0.coeffs[0]),split_uint256(u0.coeffs[1]),split_uint256(u1.coeffs[0]),split_uint256(u1.coeffs[1])).call()
