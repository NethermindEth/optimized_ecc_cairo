...
@external
func test_mul_TC_12{syscall_ptr: felt*, range_check_ptr}(
    
) {
    let (mul:FQ12) = fq12_lib.mul_TC_12(FQ12(Uint384(1,0,0),
					     Uint384(2,0,0),
					     Uint384(3,0,0),
					     Uint384(4,0,0),
					     Uint384(5,0,0),
...
@external
func test_square_TC_12{syscall_ptr: felt*, range_check_ptr}(
    
) {
    let (sq:FQ12) = fq12_lib.square_TC_12(FQ12(Uint384(2,0,0),
					       Uint384(0,0,0),
					       Uint384(0,0,0),
					       Uint384(0,0,0),
					       Uint384(0,0,0),
