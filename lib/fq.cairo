...
namespace fq_lib:
    func add{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(x : Uint384, y : Uint384) -> (
        ...
        let (sum : Uint384) = field_arithmetic.add(x, y, q)
        return (sum)
    end
    ...
    func sub{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(x : Uint384, y : Uint384) -> (
        ...
        let (res) = field_arithmetic.sub_reduced_a_and_reduced_b(x, y, q)
        return (res)
    end
    ...
    func mul{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(x : Uint384, y : Uint384) -> (
        ...
        let (q : Uint384) = get_modulus()
        let (res : Uint384) = field_arithmetic.mul(x, y, q)
        return (res)
    end
    ...
    func inverse{range_check_ptr}(a : Uint384) -> (res : Uint384):
        ...
        let (res : Uint384) = field_arithmetic.div(one, a, q)
        return (res)
    end
    ...
    func pow{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(x : Uint384, exponent : Uint384) -> (
        ...
        alloc_locals
        let (q : Uint384) = get_modulus()
        let (res : Uint384) = field_arithmetic.pow(x, exponent, q)
        return (res)
    end
    ...
    func is_square_non_optimized{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(x : Uint384) -> (
        ...
        let (res) = field_arithmetic.is_square_non_optimized(x, p, p_minus_one_div_2)
        return (res)
    end
    ...
    func get_square_root{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(x : Uint384) -> (
        ...
        let (success, res : Uint384) = field_arithmetic.get_square_root(x, p, generator)
        return (success, res)
    end
    ...
    func mul_three_terms{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
        ...
        let (res : Uint384) = mul(x_times_y, z)
        return (res)
    end
