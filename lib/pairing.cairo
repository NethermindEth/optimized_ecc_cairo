...
func line_func_gt{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(p1: GTPoint, p2: GTPoint, pt: GTPoint) -> (x: FQ12, y: FQ12) {
    alloc_locals;
...
func ate_loop{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(twist_r : GTPoint, twist_q : GTPoint, cast_p : GTPoint, f_num : FQ12, f_den : FQ12, r : G2Point, q : G2Point, n : felt) -> (twist_r : GTPoint, f_num : FQ12, f_den : FQ12, r : G2Point){
    if (n == 0){
...
func ate_loop_inner{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(twist_r : GTPoint, twist_q : GTPoint, cast_p : GTPoint, f_num : FQ12, f_den : FQ12, r : G2Point, q : G2Point, v : felt) -> (twist_r : GTPoint, f_num : FQ12, f_den : FQ12, r : G2Point){
    alloc_locals;
