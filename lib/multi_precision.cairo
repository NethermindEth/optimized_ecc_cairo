...
func left_shift_limbs(number : BigInt12, shift : felt) -> (shifted_number : BigInt12):
    ...
    assert shifted_number.d3 = [number_memory_location_plus_shift + 3]
    if shift == 8:
        return (shifted_number)
    end

    assert shifted_number.d4 = [number_memory_location_plus_shift + 4]
    if shift == 7:
        return (shifted_number)
    end

    assert shifted_number.d5 = [number_memory_location_plus_shift + 5]
    if shift == 6:
        return (shifted_number)
    end

    assert shifted_number.d6 = [number_memory_location_plus_shift + 6]
    if shift == 5:
        return (shifted_number)
    end

    assert shifted_number.d7 = [number_memory_location_plus_shift + 7]
    if shift == 4:
        return (shifted_number)
    end

    assert shifted_number.d8 = [number_memory_location_plus_shift + 8]
    if shift == 3:
        return (shifted_number)
    end

    assert shifted_number.d9 = [number_memory_location_plus_shift + 9]
    if shift == 2:
        return (shifted_number)
    end

    assert shifted_number.d10 = [number_memory_location_plus_shift + 10]
    if shift == 1:
        return (shifted_number)
    end
    return (shifted_number)
